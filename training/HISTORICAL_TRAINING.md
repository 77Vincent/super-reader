# Historical training workflows

This is the pre-`unicode-context-v1` documentation. Dataset paths, input rules, and commands below describe historical experiments; use [README.md](README.md) for the current workflow.
